...
class WebEnvironment extends Environment
{
    ...
    function render($template, array | object $context = []): string
    {

        $context = [...$context, "document" => $this->document];
        $target = $this->load(name: $template);
        $target->render(context: $context);
